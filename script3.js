...
let username= prompt("student details");
...
let length = prompt("check password length");
...
let salary = prompy("employee salary bonus");
...
let order= prompt("online food order");
